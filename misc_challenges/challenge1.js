...
//practice with Map
const myMap = new Map();
// myMap.set("firstName", "Hope");
// myMap.set("lastName", "Nesmith");

const myString = "eaabcdeed";
...
const sortedArray = [...myMap.entries()].sort((a, b) => b[1] - a[1]);
console.log(sortedArray.map(([char, count]) => char.repeat(count)).join(""));
